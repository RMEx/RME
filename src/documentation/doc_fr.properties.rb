# coding: utf-8
{
  ...
  'doc.cmd.Event.mouse_hover_player?' => "Renvoie `true` si la souris survole l'événement du joueur",
  ...
  'doc.cmd.Event.player_screen_y' => "Renvoie la coordonnée en Y par rapport à l'écran du joueur",
