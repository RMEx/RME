...
link_method_documentation 'Command.sound_BGM_play', 
  'Joue une musique BGM',
  {
    :name => ["Nom du BGM", :String],
    :volume => ["Volume du BGM", :Fixnum],
    :tempo => ["Tempo du BGM", :Fixnum],

  }
register_command :sound, 'Command.sound_BGM_play' 

# AUTOGenerated for sound_BGS_play
link_method_documentation 'Command.sound_BGS_play', 
  'Joue une musique BGS',
  {
    :name => ["Nom du BGS", :String],
    :volume => ["Volume du BGS", :Fixnum],
    :tempo => ["Tempo du BGS", :Fixnum],

  }
register_command :sound, 'Command.sound_BGS_play' 

# AUTOGenerated for sound_SE_play
link_method_documentation 'Command.sound_SE_play', 
  'Joue un SE',
  {
    :name => ["Nom du SE", :String],
    :volume => ["Volume du SE", :Fixnum],
    :tempo => ["Tempo du SE", :Fixnum],

  }
register_command :sound, 'Command.sound_SE_play' 

# AUTOGenerated for sound_ME_play
link_method_documentation 'Command.sound_ME_play', 
  'Joue un ME',
  {
    :name => ["Nom du ME", :String],
    :volume => ["Volume du ME", :Fixnum],
    :tempo => ["Tempo du ME", :Fixnum],

  }
register_command :sound, 'Command.sound_ME_play' 

# AUTOGenerated for sound_BGM_volume
link_method_documentation 'Command.sound_BGM_volume', 
  'Change le volume du BGM en cours',
  {
    :volume => ["Volume du BGM", :Fixnum],

  }
register_command :sound, 'Command.sound_BGM_volume' 

# AUTOGenerated for sound_BGS_volume
link_method_documentation 'Command.sound_BGS_volume', 
  'Change le volume du BGS en cours',
  {
    :volume => ["Volume du BGS", :Fixnum],

  }
register_command :sound, 'Command.sound_BGS_volume' 

# AUTOGenerated for sound_SE_volume
link_method_documentation 'Command.sound_SE_volume', 
  'Change le volume du SE en cours',
  {
    :volume => ["Volume du SE", :Fixnum],

  }
register_command :sound, 'Command.sound_SE_volume' 

# AUTOGenerated for sound_ME_volume
link_method_documentation 'Command.sound_ME_volume', 
  'Change le volume du ME en cours',
  {
    :volume => ["Volume du ME", :Fixnum],

  }
register_command :sound, 'Command.sound_ME_volume' 

# AUTOGenerated for sound_BGM_stop
link_method_documentation 'Command.sound_BGM_stop', 
  'Stop le BGM en cours',
  {}
register_command :sound, 'Command.sound_BGM_stop' 

# AUTOGenerated for sound_BGS_stop
link_method_documentation 'Command.sound_BGS_stop', 
  'Stop le BGS en cours',
  {}
register_command :sound, 'Command.sound_BGS_stop' 

# AUTOGenerated for sound_SE_stop
link_method_documentation 'Command.sound_SE_stop', 
  'Stop le SE en cours',
  {}
register_command :sound, 'Command.sound_SE_stop' 

# AUTOGenerated for sound_ME_stop
link_method_documentation 'Command.sound_ME_stop', 
  'Stop le ME en cours',
  {}
register_command :sound, 'Command.sound_ME_stop' 
...
link_method_documentation 'Command.sound_BGM_fade', 
  'Stop le BGM en cours en fondu',
  {
    :wait => ["Temps du fondu en seconde", :Fixnum],
    :frame => ["si true le fondu ce fait par frame sinon par seconde", :Boolean],

  }
register_command :sound, 'Command.sound_BGM_fade' 

# AUTOGenerated for sound_BGS_fade
link_method_documentation 'Command.sound_BGS_fade', 
...
register_command :sound, 'Command.sound_BGS_fade' 

# AUTOGenerated for sound_BGM_tempo
link_method_documentation 'Command.sound_BGM_tempo', 
  'Change le tempo du BGM en cours',
  {
    :tempo => ["Tempo du BGM", :Fixnum],

  }
register_command :sound, 'Command.sound_BGM_tempo' 

# AUTOGenerated for sound_BGS_tempo
link_method_documentation 'Command.sound_BGS_tempo', 
  'Change le tempo du BGS en cours',
  {
    :tempo => ["Tempo du BGS", :Fixnum],

  }
register_command :sound, 'Command.sound_BGS_tempo'

# AUTOGenerated for sound_SE_tempo
link_method_documentation 'Command.sound_SE_tempo', 
  'Change le tempo du SE en cours',
  {
    :tempo => ["Tempo du SE", :Fixnum],

  }
register_command :sound, 'Command.sound_SE_tempo'  

# AUTOGenerated for sound_ME_tempo
link_method_documentation 'Command.sound_ME_tempo', 
  'Change le tempo du ME en cours',
  {
    :tempo => ["Tempo du ME", :Fixnum],

  }
register_command :sound, 'Command.sound_ME_tempo' 

# AUTOGenerated for sound_volume
link_method_documentation 'Command.sound_volume', 
  'Change le volume de tout les sons en cours',
  {
    :volume => ["Volume des sons", :Fixnum],

  }
register_command :sound, 'Command.sound_volume' 

# AUTOGenerated for sound_fade
link_method_documentation 'Command.sound_fade', 
  'Stop les BGM et BGS en fondu',
  {
    :wait => ["Temps du fondu", :Fixnum],
    :frame => ["si true le fondu ce fait par frame sinon par seconde", :Boolean],
