...
link_method_documentation 'Command.sound_BGM_pitch',
  'Change la vitesse du BGM en cours',
  {
    :pitch => ["Vitesse du BGM", :Fixnum],

  }
register_command :sound, 'Command.sound_BGM_pitch'

# AUTOGenerated for sound_BGS_pitch
link_method_documentation 'Command.sound_BGS_pitch',
  'Change la vitesse du BGS en cours',
  {
    :pitch => ["Vitesse du BGS", :Fixnum],

  }
register_command :sound, 'Command.sound_BGS_pitch'

# AUTOGenerated for sound_SE_pitch
link_method_documentation 'Command.sound_SE_pitch',
  'Change la vitesse du SE en cours',
  {
    :pitch => ["Vitesse du SE", :Fixnum],

  }
register_command :sound, 'Command.sound_SE_pitch'

# AUTOGenerated for sound_ME_pitch
link_method_documentation 'Command.sound_ME_pitch',
  'Change la vitesse du ME en cours',
  {
    :pitch => ["Vitesse du ME", :Fixnum],

  }
register_command :sound, 'Command.sound_ME_pitch'
