...
link_method_documentation 'Command.camera_scroll_towards',
	'Fait défiler la carte vers le point de coordonnées (x, y). (Attention, ce point sera celui situé dans le coin haut-gauche de l\'écran une fois le défilement terminé)',
	{
