...
# AUTOGenerated for window_tone
link_method_documentation 'Command.window_tone',
	'Modifie la teinte de la fenêtre. Si aucune teinte n\'est passée en argument, la commande renvoi sa teinte',
 	{
		:id => ["ID de la fenêtre", :Fixnum],
		:"*tone" => ["Nouvelle teinte", :Tone],
		:"*duration" => ["Durée du déplacement", :Fixnum],
		:"*wait_flag" => ["si cet argument vaut true, on attendra la fin du déplacement", :Boolean],

	}, true # Maybe changed
register_command :window, 'Command.window_tone'
	...
	'Crée une fenêtre de sélection verticale',
 	{
		...
		:"*h" => ["Hauteur de la fenêtre, si aucun argument n'est donné, la hauteur sera calculée", :Fixnum],
