...
link_method_documentation 'Command.event_trigger', 
  'Change le type de déclanchement des événements référencés par leur IDS (0: touche action, 1: contact du héros, 2: contact de l\'event, 3: automatique, 4: processus paralléle).',
  {
    :ids => ["ID des événements", :Selector],
    :trigger => ["Type de déclanchement", :Fixnum],
