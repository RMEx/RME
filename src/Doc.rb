...
register_command :standard, 'Command.event_move_down' 
...
register_command :standard, 'Command.event_move_left' 
...
register_command :standard, 'Command.event_move_right' 
...
register_command :standard, 'Command.event_move_up' 
...
link_method_documentation 'Command.player_move_down', 
	'Fait bouger le joueur d\'une case vers le bas',
 	{:"*turn_ok" => ["En cas d'échec de déplacement, si turn_ok vaut true, l'événement se tournera dans la direction du mouvement. (par défaut, true)", :Boolean]}
register_command :standard, 'Command.player_move_down' 
...
link_method_documentation 'Command.player_move_left', 
	'Fait bouger le joueur d\'une case vers la gauche. Renvoie true si le déplacement s\'est effectué, false sinon.',
 	{:"*turn_ok" => ["En cas d'échec de déplacement, si turn_ok vaut true, l'événement se tournera dans la direction du mouvement. (par défaut, true)", :Boolean]}
register_command :standard, 'Command.player_move_left' 
...
link_method_documentation 'Command.player_move_right', 
	'Fait bouger le joueur d\'une case vers la droite. Renvoie true si le déplacement s\'est effectué, false sinon.',
 	{:"*turn_ok" => ["En cas d'échec de déplacement, si turn_ok vaut true, l'événement se tournera dans la direction du mouvement. (par défaut, true)", :Boolean]}
register_command :standard, 'Command.player_move_right' 
...
link_method_documentation 'Command.player_move_up', 
	'Fait bouger le joueur d\'une case vers le haut. Renvoie true si le déplacement s\'est effectué, false sinon.',
 	{:"*turn_ok" => ["En cas d'échec de déplacement, si turn_ok vaut true, l'événement se tournera dans la direction du mouvement. (par défaut, true)", :Boolean]}
register_command :standard, 'Command.player_move_up' 
...
register_command :standard, 'Command.event_move_straight' 
...
register_command :standard, 'Command.player_move_straight' 
...
register_command :standard, 'Command.event_move_random' 
...
link_method_documentation 'Command.player_move_random', 
	'Déplacele héro d\' une case aléatoire.',
 	{}
register_command :standard, 'Command.player_move_random'
...
register_command :standard, 'Command.event_move_diagonal' 
...
register_command :standard, 'Command.player_move_diagonal' 
...
register_command :standard, 'Command.event_move_toward_position' 
...
register_command :standard, 'Command.player_move_toward_position' 
