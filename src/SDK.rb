...
module Gui
  ...
  module Components
    ...
    class Text_Field
      ...
      def text_data
        @char_rect = @sprite.bitmap.text_size("W")
      end
      ...
      def update_cursor_pos
        ...
        if pos == 0
          ...
          @cursor.x = @sprite.bitmap.text_size(@text.value[0..pos-1]).width
        end
      end
    ...
    class Text_Recorder
      ...
      def update_value_modification
        if Keyboard.krepeat?(0x08) && @virtual_position != 0
          go_left
